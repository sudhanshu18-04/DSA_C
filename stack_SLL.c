...
NODE * createnode(int ele)                         //To make a node with given stack element and return its address.
{
    NODE *NewNode;
...
{
    NODE *temp;
    temp=createnode(ele);          //getting a node with data as element given by the user
